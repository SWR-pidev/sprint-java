...
import com.swr.IService.IServiceCat;
...
List<Categorie> arr=new ArrayList<>();
    ...
    return arr;
        ...
        @Override
    public int sercat(String cat) throws SQLException {
int i=0;
    ste=con.createStatement();
    ResultSet rs=ste.executeQuery("select * from categorie where nomcat='"+cat+"' ;");
     while (rs.next()) {                
